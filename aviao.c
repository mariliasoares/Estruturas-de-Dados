	...
	// void tratar_arquivo(FILE *arquivo) {
	// 	char *texto, vet[50];
	// 	char nome[20], preferencial[9];
	// 	int dia, mes, ano, cod, especial, ativo, fileira, colunanum, i = 1, cod;


	//     while(!feof(arquivo)) {
	//         fgets(vet,50,arquivo);
	//         texto = strtok(vet, ";" ); //separa uma string ate o ponto e virgula

	//         while(texto) {

	//             if(i == 1)
	//         	{
	//         	    cod = atoi(texto); //converte a string em um inteiro
	// 				i = 2;
	//         	}
	//         	else if(i == 2)
	//             {
	//         		strcpy(nome, texto); //copia o nome do aluno para variavel vet
	// 				i = 3;
	//         	}
	//         	else if(i == 3)
	//             {
	...
	//         	else if(i == 2)
	//             {
	//         		strcpy(preferencial, texto); //copia o nome do aluno para variavel vet
					
	//         		inserir_novo_registro(cod, nome, dia, mes, ano, coluna, fileira, preferencial);
	//         		i = 1;
	//         	}
    //             texto = strtok( NULL, ";" );
    //             if(texto !=NULL){
